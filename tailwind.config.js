...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      ========================== */
      colors: {
        // Primary: OR ROYAL (Palais Royal du Bénin)
        primary: {
          50: "#fffef0",
          100: "#fffddb",
          200: "#fff9b7",
        ...
        // Secondary: ROUGE PROFOND (Prestige)
        secondary: {
          50: "#ffe6e6",
          100: "#ffb3b3",
          200: "#ff8080",
      ...
      ========================== */
      backgroundImage: {
        "gradient-primary": "linear-gradient(135deg, #5568ff 0%, #3d4eff 100%)",
        "gradient-primary-light": "linear-gradient(135deg, #a4baff 0%, #7c93ff 100%)",
        "gradient-secondary": "linear-gradient(135deg, #ffb833 0%, #ffc855 100%)",
