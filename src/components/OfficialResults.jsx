...
// proclamation en direct que sur le podium final.
const RANK_TITLES = {
...
function PodiumCard({ entry, size }) {
  ...
  const title = RANK_TITLES[entry.rank];
  return (
...
export default function OfficialResults() {
  ...
  if (!data?.finalRevealed) {
    ...
    return <RevealSpotlight revealed={revealed} groupSize={data.groupSize} />;
  }
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 sm:py-16">
      ...
      <div className="mb-16 flex flex-wrap items-end justify-center gap-8 sm:gap-14">
        {top3[1] && <PodiumCard entry={top3[1]} size="sm" />}
        {top3[0] && <PodiumCard entry={top3[0]} size="lg" />}
        {top3[2] && <PodiumCard entry={top3[2]} size="sm" />}
      </div>
