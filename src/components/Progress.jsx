  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-8 sm:py-12">
      <div className={`rounded-2xl border backdrop-blur-xl transition-all duration-500 ${
        ...
        {/* Timeline Info */}
        <div className="px-6 sm:px-8 py-4 bg-slate-50/50 rounded-b-xl grid grid-cols-3 gap-4 text-center border-t border-slate-100">
          <div>
            <p className="text-xs text-slate-500 uppercase tracking-wide">Début</p>
          ...
          <div>
            <p className="text-xs text-slate-500 uppercase tracking-wide">Maintenant</p>
            <p className="text-sm font-semibold text-primary-600">{new Date().toLocaleDateString("fr-FR", { month: "short", day: "numeric" })}</p>
          </div>
          <div>
