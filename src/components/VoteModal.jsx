  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-fade-in">
      <div className="w-full max-w-md sm:max-w-lg bg-white rounded-1xl p-2 sm:p-8 shadow-2xl animate-slide-up overflow-y-auto max-h-[90vh]">
        ...
        {/* HEADER */}
        <div className="relative bg-gradient-to-r from-purple-700 via-violet-600 to-fuchsia-600 px-6 py-2 text-white">
          ...
          <p className="mt-2 text-sm text-white/90">
            Soutenez votre candidate favorite et augmentez ses chances de victoire.
          </p>
        </div>
        ...
        <div className="p-0">
          ...
          <div className="mb-0">
            ...
            <div className="grid grid-cols-5 gap-21">
              {[5, 10, 30,50, 100].map((value) => (
                <button
                  key={value}
                  onClick={() => setVotes(String(value))}
                  className="rounded-xl border border-gray-200 py-3 font-semibold transition hover:border-purple-500 hover:bg-purple-50"
                >
                  {value}
                </button>
              ))}
          ...
          <label className="block mb-2">
            ...
            <input
              ...
              placeholder="Ex: 10"
              className="w-full rounded-2xl border-1 border-gray-200 p-2 text-center text-xl font-bold focus:border-purple-500 focus:outline-none"
            />
          </label>
          ...
          <button
            onClick={handlePay}
            disabled={loading}
            className="w-full rounded-2xl bg-gradient-to-r from-purple-700 to-red-600 py-4 text-lg font-bold text-white shadow-lg transition hover:scale-[1.02] disabled:opacity-70"
          >
            {loading
